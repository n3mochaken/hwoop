public class Main {
    public static void main(String[] args) {
        ...
        ChzhouChang.comparison(PadmaPatil, MarcusBelby);
        DracoMalfoy.comparison(DracoMalfoy,GrahamMontegu);
        HarryPotter.comparison(HernionaGraiger,RonalzWizzly);
        ZahariaSmith.comparison(SedricDigory,JustinFinchFletchli);

        hogwarts.comparison(HarryPotter,GragoryGoil);
